...
FOREIGN_LANGUAGE_SPECS = {
    ...
    "多模态学习包": {
        "requirements": ["对话脚本", "词汇卡片", "语法图解", "角色扮演任务", "听说训练提示", "PPT 页纲"],
        "quality_constraints": ["多模态围绕听说读写和图解", "不得包含代码注释、伪代码或函数"],
    },
    "错题诊断与学习反馈报告": {
...
MATHEMATICS_SPECS = {
    ...
    "多模态学习包": ["公式图解", "推导步骤", "例题拆解", "PPT 页纲", "错题卡片"],
...
PHYSICS_SPECS = {
    ...
    "多模态学习包": ["现象图解", "公式拆解", "实验步骤", "PPT 页纲", "题解"],
