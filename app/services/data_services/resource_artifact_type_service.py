...
INTERACTIVE_ANIMATION = "交互动画规格"
ANIMATION_STORYBOARD = "动画分镜"
PROJECT_BRIEF = "课程实践项目任务书"
...
ARTIFACT_REQUIREMENTS = {
    ...
    CODE_LAB: ["实验目标", "环境依赖", "数据集说明", "模型结构", "训练流程", "完整代码", "运行方式", "调参任务", "实验报告模板", "常见报错"],
    ...
    PROJECT_BRIEF: ["项目背景", "项目目标", "数据集建议", "技术路线", "任务拆解", "验收标准", "提交物", "评分 Rubric", "扩展方向"],
