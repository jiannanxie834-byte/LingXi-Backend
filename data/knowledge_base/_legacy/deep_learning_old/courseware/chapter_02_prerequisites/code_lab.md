# 第 2 章 张量、矩阵乘法与自动求梯度实验

## 1. 实验目标
围绕「张量、矩阵乘法、梯度和训练/验证拆分」完成一个可运行实验，要求学生能解释输入 shape、模型输出、损失变化、关键超参数和实验结论之间的关系。
...
## 4. 完整代码
将下面代码保存为 `chapter_02_tensor_autograd_demo.py`。
...
4. 用 150 字解释该实验如何帮助理解「张量、矩阵乘法、梯度和训练/验证拆分」。
