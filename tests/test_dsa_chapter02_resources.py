...
CHAPTER_DIR = COURSE_DIR / "courseware" / "chapter_02_linear_structures"
CHAPTER_ID = "chapter_02_linear_structures"
...
class DsaChapter02ResourcesTest(unittest.TestCase):
    def test_chapter_02_has_required_six_sections(self):
        expected_files = [
            "01_linear_structure_intro.md",
            "02_array.md",
            "03_linked_list.md",
            "04_stack.md",
            "05_queue_deque.md",
            "06_two_pointers_monotonic_stack.md",
        ]
    ...
    def test_chapter_02_resource_counts_and_no_forbidden_references(self):
    ...
    def test_chapter_02_global_indexes_are_aligned(self):
        ...
        self.assertEqual(chapter["sections"][0]["section_id"], "sec_02_linear_structure_intro")
        ...
        self.assertIn("dsa_linear_structure_intro", unit_ids)
        self.assertIn("dsa_array_operations", unit_ids)
        self.assertIn("dsa_monotonic_stack_intro", unit_ids)
