...
CHAPTER_DIR = COURSE_DIR / "courseware" / "chapter_06_trees"
CHAPTER_ID = "chapter_06_trees"
...
class DsaChapter06ResourcesTest(unittest.TestCase):
    def test_chapter_06_has_required_six_sections(self):
        expected_files = [
            "01_tree_basic.md",
            "02_binary_tree_basic.md",
            "03_tree_traversal.md",
            "04_level_order_traversal.md",
            "05_binary_search_tree.md",
            "06_tree_recursion_pattern.md",
        ]
    ...
    def test_chapter_06_resource_counts_and_no_forbidden_references(self):
    ...
    def test_chapter_06_global_indexes_are_aligned(self):
        ...
        self.assertEqual(chapter["sections"][0]["section_id"], "sec_06_tree_basic")
        self.assertEqual(chapter["sections"][5]["section_id"], "sec_06_tree_recursion_pattern")
        ...
        self.assertIn("dsa_tree_basic", unit_ids)
        self.assertIn("dsa_level_order_traversal", unit_ids)
        self.assertIn("dsa_tree_recursion_pattern", unit_ids)
