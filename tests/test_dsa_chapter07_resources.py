...
CHAPTER_DIR = COURSE_DIR / "courseware" / "chapter_07_graph_traversal"
CHAPTER_ID = "chapter_07_graph_traversal"
...
class DsaChapter07ResourcesTest(unittest.TestCase):
    def test_chapter_07_has_required_six_sections(self):
        expected_files = [
            "01_graph_basic.md",
            "02_graph_representation.md",
            "03_bfs.md",
            "04_dfs.md",
            "05_connected_components.md",
            "06_maze_and_topological_intro.md",
        ]
    ...
    def test_chapter_07_resource_counts_and_no_forbidden_references(self):
    ...
    def test_chapter_07_global_indexes_are_aligned(self):
        ...
        self.assertEqual(chapter["sections"][0]["section_id"], "sec_07_graph_basic")
        self.assertEqual(chapter["sections"][5]["section_id"], "sec_07_maze_topological_intro")
        ...
        self.assertIn("dsa_graph_basic", unit_ids)
        self.assertIn("dsa_bfs", unit_ids)
        self.assertIn("dsa_topological_sort_intro", unit_ids)
