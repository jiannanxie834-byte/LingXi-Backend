...
CHAPTER_DIR = COURSE_DIR / "courseware" / "chapter_03_recursion_divide_backtracking"
CHAPTER_ID = "chapter_03_recursion_divide_backtracking"
...
class DsaChapter03ResourcesTest(unittest.TestCase):
    def test_chapter_03_has_required_six_sections(self):
        expected_files = [
            "01_recursion_basic.md",
            "02_call_stack.md",
            "03_divide_and_conquer.md",
            "04_binary_search_recursion.md",
            "05_backtracking_basic.md",
            "06_permutation_combination.md",
        ]
    ...
    def test_chapter_03_resource_counts_and_no_forbidden_references(self):
    ...
    def test_chapter_03_global_indexes_are_aligned(self):
        ...
        self.assertEqual(chapter["sections"][2]["section_id"], "sec_03_divide_and_conquer")
        ...
        self.assertIn("dsa_recursion_base_case", unit_ids)
        self.assertIn("dsa_choice_explore_undo", unit_ids)
        self.assertIn("dsa_search_tree_intro", unit_ids)
