...
CHAPTER_DIR = COURSE_DIR / "courseware" / "chapter_08_shortest_path_mst"
CHAPTER_ID = "chapter_08_shortest_path_mst"
...
class DsaChapter08ResourcesTest(unittest.TestCase):
    def test_chapter_08_has_required_six_sections(self):
        expected_files = [
            "01_shortest_path_intro.md",
            "02_dijkstra.md",
            "03_bellman_ford_floyd_intro.md",
            "04_mst_intro.md",
            "05_kruskal_prim.md",
            "06_union_find_for_mst.md",
        ]
    ...
    def test_chapter_08_resource_counts_and_no_forbidden_references(self):
    ...
    def test_chapter_08_global_indexes_are_aligned(self):
        ...
        self.assertEqual(chapter["sections"][0]["section_id"], "sec_08_shortest_path_intro")
        self.assertEqual(chapter["sections"][5]["section_id"], "sec_08_union_find_for_mst")
        ...
        self.assertIn("dsa_shortest_path_problem", unit_ids)
        self.assertIn("dsa_dijkstra", unit_ids)
        self.assertIn("dsa_union_find", unit_ids)
