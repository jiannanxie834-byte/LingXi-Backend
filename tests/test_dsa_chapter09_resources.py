...
CHAPTER_DIR = COURSE_DIR / "courseware" / "chapter_09_greedy"
CHAPTER_ID = "chapter_09_greedy"
...
class DsaChapter09ResourcesTest(unittest.TestCase):
    def test_chapter_09_has_required_six_sections(self):
        expected_files = [
            "01_greedy_intro.md",
            "02_greedy_choice_property.md",
            "03_interval_scheduling.md",
            "04_activity_selection.md",
            "05_huffman_intro.md",
            "06_greedy_counterexample.md",
        ]
    ...
    def test_chapter_09_resource_counts_and_no_forbidden_references(self):
    ...
    def test_chapter_09_global_indexes_are_aligned(self):
        ...
        self.assertEqual(chapter["sections"][0]["section_id"], "sec_09_greedy_intro")
        self.assertEqual(chapter["sections"][5]["section_id"], "sec_09_greedy_counterexample")
        ...
        self.assertIn("dsa_greedy_intro", unit_ids)
        self.assertIn("dsa_interval_scheduling", unit_ids)
        self.assertIn("dsa_greedy_vs_dp_intro", unit_ids)
