...
CHAPTER_DIR = COURSE_DIR / "courseware" / "chapter_11_string_algorithms"
CHAPTER_ID = "chapter_11_string_algorithms"
...
class DsaChapter11ResourcesTest(unittest.TestCase):
    def test_chapter_11_has_required_six_sections(self):
        expected_files = [
            "01_string_basic.md",
            "02_brute_force_matching.md",
            "03_kmp_intro.md",
            "04_prefix_function.md",
            "05_trie.md",
            "06_rolling_hash_intro.md",
        ]
    ...
    def test_chapter_11_resource_counts_and_video_policy(self):
    ...
    def test_chapter_11_global_indexes_are_aligned(self):
        ...
        self.assertEqual(chapter["sections"][0]["section_id"], "sec_11_string_basic")
        self.assertEqual(chapter["sections"][5]["section_id"], "sec_11_rolling_hash_intro")
        ...
        for unit_id in [
            "dsa_string_basic",
            "dsa_substring_pattern_text",
            "dsa_brute_force_matching",
            "dsa_string_matching_complexity",
            "dsa_kmp_intro",
            "dsa_prefix_function",
            "dsa_kmp_next_array",
            "dsa_trie",
            "dsa_trie_insert_search",
            "dsa_rolling_hash_intro",
        ]:
            self.assertIn(unit_id, unit_ids)

    def test_chapter_11_has_no_forbidden_references(self):
        forbidden = [
            "TODO",
            "LeetCode",
            "main_note.md",
